...
try:
    ...
    # 位置偏差許容    default:[100,100,100,10,10,10]
    PosEralw = [1.3, 1.4, 1.5, 1.6, 1.7, 1.8]
    Spring = [3.7, 3.8, 3.9, 4.0, 4.1, 4.2]  # 柔らかさ  default:100[%]
    # 慣性 default:[100,100,100,100,100,100]
    Mass = [3.1, 3.2, 3.3, 3.4, 3.5, 3.6]
    Damp = [2.5, 2.6, 2.7, 2.8, 2.9, 3.0]  # 粘性 default:100[%]
    # 電流制限値 default:[100,100,100,100,100,100]
    CurLmt = [100, 100, 100, 100, 100, 100]
    Offset = [0, 0, 0, 0, 0, 0]  # オフセット値   default:[0,0,0,0,0,0]
    # 各軸偏差許容    default:[10,10,10,10,10,10]
    Eralw = [1.9, 2.0, 2.1, 2.2, 2.3, 2.4]
    ...
    Param = [CtrlNum, Coordinates, Force, PosEralw, Spring, Mass,
             Damp, CurLmt, Offset, Eralw, lMode, Rate, SpMax, RSpMax]
