...
SystemStatus = ["Reserved", "Reserved", "Reserved", "Reserved", "Reserved", "Reserved", "Reserved", "Command processing complete", "Reserved", "Reserved", "Robot is running (encoder level)", "Robot is running (command level)", "1 cycle complete", "Manual mode or Teach check mode", "Cal complete", "Program start reset", "Reserved", "Reserved", "When stop process is running", "Protective Stop", "Automatic robot run enabled",
                "Emergency stop status", "Reserved", "Continue start allowed", "Robot warning", "Battery exhaustion warning", "When an executable token is not set to the Teach Pendant in Auto Mode", "Automatic mode", "Robot initialization complete (in I/O standard or MiniIO dedicated mode) / Robot power On complete (in I/O compatible mode)", "Servo On", "Robot error", "Robot in operation (program running)"]
